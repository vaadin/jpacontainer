...
/**
 * Abstract test case for {@link MutableEntityProvider} that should work
 ...
 * @since 1.0
 */
public abstract class AbstractMutableEntityProviderEMTest extends AbstractEntityProviderEMTest {
    ...
    public void testAddEntity() {
        ...
        Person returned = ((MutableEntityProvider<Person>) entityProvider).addEntity(p);
    ...
    public void testRemoveEntity() {
        ...
        ((MutableEntityProvider<Person>) entityProvider).removeEntity(p.getId());
    ...
    public void testUpdateEntity() {
        ...
        Person returned = ((MutableEntityProvider<Person>) entityProvider).updateEntity(p);
