...
/**
 * Integration test for {@link LocalEntityProvider} that uses
 * Hibernate as the entity manager provider.
 * 
 * @author Petter Holmström (IT Mill)
 * @since 1.0
 */
public class HibernateIntegrationTest extends AbstractIntegrationTest {
