...
public class FieldFactory extends DefaultFieldFactory {
     ...
     * for a field. By default it copies {@link LazyLoadingDelegate} from the
     * reference container and registers the created container to
     * {@link EntityManagerPerRequestHelper} if one is in use.
     * 
     * @param referenceContainer
     * @param container
     */
