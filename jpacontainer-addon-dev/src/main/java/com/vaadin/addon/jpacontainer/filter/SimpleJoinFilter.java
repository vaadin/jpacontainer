 ...
 * assumes that the alias of the joined property is the name of the join
 * propery. For example, if the property to be joined is named
 * <code>skills</code>, then the join should look like this:
 * <code>select Person as obj join obj.skills as skills where ...</code>.
 * 
...
public class SimpleJoinFilter extends Conjunction implements JoinFilter {
    ...
    /**
     * <strong>This implementation does not use
     * <code>propertyIdPreprocessor</code> at all.</strong>
     * <p>
     * {@inheritDoc }
     */
    @Override
