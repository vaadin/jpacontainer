...
public class JPAContainerTest {
    ...
    public void testIndexOfId_Buffered() {
        ...
        expect(batchableEntityProviderMock.getEntityCount(null)).andStubReturn(5);
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null, sortby, 0)).
                andStubReturn("id1");
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null, sortby, 1)).
                andStubReturn("id2");
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null, sortby, 2)).
                andStubReturn("id3");
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null, sortby, 3)).
                andStubReturn("id4");
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null, sortby, 4)).
                andStubReturn(null);
    ...
    public void testGetIdByIndex_Buffered() {
        LinkedList<SortBy> orderby = new LinkedList<SortBy>();
        orderby.add(new SortBy("firstName", true));
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null,
                new LinkedList<SortBy>(), 0)).andStubReturn("id1");
        expect(batchableEntityProviderMock.getEntityIdentifierAt(null,
                new LinkedList<SortBy>(), 1)).andStubReturn(null);
        expect(batchableEntityProviderMock.getEntityIdentifierAt(Filters.and(Filters.
                eq(
                "firstName", "Hello", false)), orderby, 2)).andStubReturn("id3");
    ...
    public void testGetItemIds_Buffered() {
        ...
        expect(batchableEntityProviderMock.getAllEntityIdentifiers(null, orderby)).
                andStubReturn(idList);
        expect(batchableEntityProviderMock.containsEntity("id4", null)).
                andStubReturn(true);
        replay(batchableEntityProviderMock);
    ...
    public void testGetItem_Buffered() {
        ...
        expect(batchableEntityProviderMock.getEntity(123l)).andStubAnswer(new IAnswer<Person>() {
        ...
        // Fetch it again
        item = container.getItem(123l);
        assertEquals("Jim", item.getItemProperty("firstName").getValue()); // Fetched from cache
        assertTrue(item.isPersistent());
        assertTrue(item.isDirty());
        assertFalse(item.isModified());
        assertFalse(item.isDeleted());
        ...
        // Fetch it again
        item = container.getItem(123l);
        assertEquals("Joe", item.getItemProperty("firstName").getValue()); // Fetched from provider
        assertTrue(item.isPersistent());
        assertFalse(item.isDirty());
        assertFalse(item.isModified());
    ...
    public void testContainsId_Buffered() {
        ...
        expect(batchableEntityProviderMock.containsEntity("id2", null)).
                andStubReturn(true);
        expect(batchableEntityProviderMock.containsEntity("id", Filters.and(Filters.
                eq(
                "firstName", "Hello", false)))).andStubReturn(true);
        expect(batchableEntityProviderMock.containsEntity("id2", Filters.and(Filters.
                eq(
                "firstName", "Hello", false)))).andStubReturn(false);
        replay(batchableEntityProviderMock);
    ...
    public void testFirstItemIdAndIsFirstId_Buffered() {
        LinkedList<SortBy> orderby = new LinkedList<SortBy>();
        orderby.add(new SortBy("firstName", true));
        expect(batchableEntityProviderMock.getFirstEntityIdentifier(null,
                new LinkedList<SortBy>())).andReturn("id1").times(2).andReturn(
                null).times(2);
        expect(batchableEntityProviderMock.getFirstEntityIdentifier(Filters.and(Filters.
                eq("firstName", "Hello", false)), orderby)).andReturn("id2").
                times(3);
        replay(batchableEntityProviderMock);
    ...
    public void testAddEntity_Buffered_Commit() {
        ...
        expect(batchableEntityProviderMock.getNextEntityIdentifier(122l, null,
                orderby)).andStubReturn(123l);
        expect(batchableEntityProviderMock.getPreviousEntityIdentifier(122l,
        ...
        expect(batchableEntityProviderMock.getEntity(anyObject())).andStubReturn(
                null);
        replay(batchableEntityProviderMock);
        ...
        container.addListener(new ItemSetChangeListener() {
            ...
            public void containerItemSetChange(ItemSetChangeEvent event) {
                if (listenerCalled[0] == 0) {
                    ...
                    assertTrue(
                            event instanceof JPAContainer.ChangesCommittedEvent);
                }
                listenerCalled[0]++;
            }
        });
