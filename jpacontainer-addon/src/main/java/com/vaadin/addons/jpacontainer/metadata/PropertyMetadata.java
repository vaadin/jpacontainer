...
public class PropertyMetadata implements Serializable {
     ...
     * @param setter the setter method that can be used to set the value of the property (may be null).
     */
    PropertyMetadata(String name, Class<?> type, Method getter, Method setter) {
        assert name != null : "name must not be null";
        assert type != null : "type must not be null";
        /*
         * If we assert that getter != null, PersistentPropertyMetadata
         * will not work.
         */
        this.name = name;
        this.type = type;
        ...
        this.setter = setter;
        /*
         * The getter may also be null, e.g. if PersistentPropertyMetadata
         * uses a field instead of a getter to access the property.
         */
        if (getter != null) {
    ...
    public Object readResolve() throws ObjectStreamException {
        try {
            ...
            Method setterM = null;
            if (setterName != null) {
                setterM = setterDeclaringClass.getDeclaredMethod(setterName, type);
            }
    ...
    public boolean equals(Object obj) {
        if (obj.getClass() == getClass()) {
            ...
            return name.equals(other.name)
                    ...
                    && (getter == null ? other.getter == null : getter.equals(
                    other.getter))
                    && (setter == null ? other.setter == null : setter.equals(
                    other.setter));
        }
        return false;
    }
