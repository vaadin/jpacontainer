...
public interface Junction extends Filter {
    ...
    /**
     * Removes <code>filter</code> from the list of filters. If it has been added more than once,
     * only the first occurence will be remoed. If it has never been added, nothing happens.
     *
