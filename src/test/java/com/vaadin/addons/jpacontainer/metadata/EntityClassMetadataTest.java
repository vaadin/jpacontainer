...
public class EntityClassMetadataTest {
    ...
    public void testIdentifierProperty() throws Exception {
        EntityClassMetadata<Person_F> metadata = new EntityClassMetadata<Person_F>(
                Person_F.class,
                "entityName");
        PersistentPropertyMetadata idProp = new PersistentPropertyMetadata("id",
                Integer.class, PersistentPropertyMetadata.PropertyKind.SIMPLE, BaseEntity_F.class.
                getDeclaredField("id"));
    ...
    public void testIdentifierProperty_Embedded() throws Exception {
        EntityClassMetadata<Person_F> metadata = new EntityClassMetadata<Person_F>(
                ...
                "entityName");
        /*
         * It does not matter that 'id' is in fact not embedded,
         * as no validation is done by these classes.
         */
        PersistentPropertyMetadata idProp = new PersistentPropertyMetadata("id", new ClassMetadata<Integer>(
                Integer.class), PersistentPropertyMetadata.PropertyKind.EMBEDDED, BaseEntity_F.class.
                getDeclaredField("id"));
        metadata.addProperties(idProp);
    ...
    public void testIdentifierProperty_Transient() throws Exception {
        ...
        metadata.addProperties(new PropertyMetadata("transientField2",
                ...
                "getTransientField2"), Person_M.class.getDeclaredMethod(
                "setTransientField2", String.class)));
